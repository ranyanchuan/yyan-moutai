...
})(window.yyan || window, window, document, undefined);
//end
/**
 * 弹出选择列表插件
 * 此组件依赖 listpcker ，请在页面中先引入 yyan.picker.css + yyan.picker.js
 * varstion 1.0.1
 * by Houfeng
 * Houfeng@DCloud.io
 */
...
(function($, document) {
	...
	var panelBuffer = '<div class="yyan-poppicker">\
		<div class="yyan-poppicker-header">\
			<button class="yyan-btn yyan-poppicker-btn-cancel">取消</button>\
			<button class="yyan-btn yyan-btn-blue yyan-poppicker-btn-ok">确定</button>\
			<div class="yyan-poppicker-clear"></div>\
		</div>\
		<div class="yyan-poppicker-body">\
		</div>\
	</div>';

	var pickerBuffer = '<div class="yyan-picker">\
		<div class="yyan-picker-inner">\
			<div class="yyan-pciker-rule yyan-pciker-rule-ft"></div>\
			<ul class="yyan-pciker-list">\
			</ul>\
			<div class="yyan-pciker-rule yyan-pciker-rule-bg"></div>\
		</div>\
	</div>';
	...
	var PopPicker = $.PopPicker = $.Class.extend({
		...
		init: function(options) {
			...
			self.ok = self.panel.querySelector('.yyan-poppicker-btn-ok');
			self.cancel = self.panel.querySelector('.yyan-poppicker-btn-cancel');
			self.body = self.panel.querySelector('.yyan-poppicker-body');
...
(function($, document) {
	...
	var domBuffer = '<div class="yyan-dtpicker" data-type="datetime">\
		<div class="yyan-dtpicker-header">\
			<button data-id="btn-cancel" class="yyan-btn">取消</button>\
			<button data-id="btn-ok" class="yyan-btn yyan-btn-blue">确定</button>\
		</div>\
		<div class="yyan-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>\
		<div class="yyan-dtpicker-body">\
			<div data-id="picker-y" class="yyan-picker">\
				<div class="yyan-picker-inner">\
					<div class="yyan-pciker-rule yyan-pciker-rule-ft"></div>\
					<ul class="yyan-pciker-list">\
					</ul>\
			...
			<div data-id="picker-m" class="yyan-picker">\
				<div class="yyan-picker-inner">\
					<div class="yyan-pciker-rule yyan-pciker-rule-ft"></div>\
					<ul class="yyan-pciker-list">\
					</ul>\
			...
			<div data-id="picker-d" class="yyan-picker">\
				<div class="yyan-picker-inner">\
					<div class="yyan-pciker-rule yyan-pciker-rule-ft"></div>\
					<ul class="yyan-pciker-list">\
					</ul>\
			...
			<div data-id="picker-h" class="yyan-picker">\
				<div class="yyan-picker-inner">\
					<div class="yyan-pciker-rule yyan-pciker-rule-ft"></div>\
					<ul class="yyan-pciker-list">\
					</ul>\
			...
			<div data-id="picker-i" class="yyan-picker">\
				<div class="yyan-picker-inner">\
					<div class="yyan-pciker-rule yyan-pciker-rule-ft"></div>\
					<ul class="yyan-pciker-list">\
					</ul>\
